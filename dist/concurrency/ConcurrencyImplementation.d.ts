import { Page, ConnectOptions, Browser } from 'puppeteer';
/**
...
export default abstract class ConcurrencyImplementation {
     ...
     */
    abstract workerInstance(perBrowserOptions: ConnectOptions | undefined): Promise<WorkerInstance>;
}
/**
...
export type ConcurrencyImplementationClassType = new (options: ConnectOptions, puppeteer: any) => ConcurrencyImplementation;
